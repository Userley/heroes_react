...
import MessageInputNull from '../Messages/MessageInputNull';
        ...
        <div className="panel-body form-horizontal payment-form">
          <div className="form-group">
            ...
            <div className="col-sm-9">
              ...
              />
              {(props.formValues.Company === '' && props.vacio === true) && (
                <MessageInputNull />
              )}
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-sm-9">
              <input
                ...
                onChange={props.onChangeInput}
              />
              {(props.formValues.Name === '' && props.vacio === true) && (
                <MessageInputNull />
              )}
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-sm-9">
              <input
                ...
                onChange={props.onChangeInput}
              />
              {(props.formValues.Movie === '' && props.vacio === true) && (
                <MessageInputNull />
              )}
            </div>
          </div>
          <div className="form-group">
            ...
            <div className="col-sm-9">
              <input
                ...
                onChange={props.onChangeInput}
              />
              {(props.formValues.PhotoUrl === '' && props.vacio === true) && (
                <MessageInputNull />
              )}
            </div>
          </div>
